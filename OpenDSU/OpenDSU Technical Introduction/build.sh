#node ../bin/text2mp3.js ./texts/S0 ./voice/S0.mp3
...
#ffmpeg -loop 1 -i ./slides/S0.png  -vf "scale=960:540" -c:v libaom-av1 -crf 0 -t 38 -r 24 -pix_fmt yuva444p -b:v 4000k ./video/S0.mp4
#ffmpeg -loop 1 -i ./slides/S1.png  -vf "scale=960:540" -c:v libaom-av1 -crf 0 -t 123 -r 24 -pix_fmt yuva444p -b:v 4000k ./video/S1.mp4
...
ffmpeg -loop 1 -i ./slides/S5.png  -vf "scale=960:540" -c:v libaom-av1 -crf 0 -t 93 -r 24 -pix_fmt yuva444p -b:v 4000k ./video/S5.mp4
#ffmpeg -loop 1 -i ./slides/S6.png  -vf "scale=960:540" -c:v libaom-av1 -crf 0 -t 95 -r 24 -pix_fmt yuva444p -b:v 4000k ./video/S6.mp4
#ffmpeg -loop 1 -i ./slides/S7.png  -vf "scale=960:540" -c:v libaom-av1 -crf 0 -t 52 -r 24 -pix_fmt yuva444p -b:v 4000k ./video/S7.mp4
#ffmpeg -loop 1 -i ./slides/S8.png  -vf "scale=960:540" -c:v libaom-av1 -crf 0 -t 113 -r 24 -pix_fmt yuva444p -b:v 4000k ./video/S8.mp4
#ffmpeg -loop 1 -i ./slides/S9.png  -vf "scale=960:540" -c:v libaom-av1 -crf 0 -t 88 -r 24 -pix_fmt yuva444p -b:v 4000k ./video/S9.mp4
...
#ffmpeg -loop 1 -i ./slides/S17.png  -vf "scale=960:540" -c:v libaom-av1 -crf 0 -t 45 -r 24 -pix_fmt yuva444p -b:v 4000k ./video/S17.mp4
...
cd ..
ffmpeg -i ./temp/allsound.mp3 -i ./temp/allvideo.mp4 -c:v copy -c:a aac ./output/OpenDSUTechnicalIntroduction.mp4
